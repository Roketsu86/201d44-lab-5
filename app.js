...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    var outputSumOne = sum(a, b)[0];
    var outputSumTwo = sum(outputSumOne, c)[0];
    var outputProductOne = multiply(a, b)[0];
    var outputProductTwo = multiply(outputProductOne, c)[0];
    var messageOne = (a + ' and ' + b + ' and ' + c + ' sum to ' + outputSumTwo + '.');
    var messageTwo = ('The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + outputProductTwo + '.');
    return[outputSumTwo, outputProductTwo, messageOne, messageTwo];
}
...
function sumArray(sumArr) { //eslint-disable-line
    var outputOne = sum(sumArr[0], sumArr[1])[0];
    var outputTwo = sum(outputOne, sumArr[2])[0];
    var message = (sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + outputTwo + ' is their sum.');
    return[outputTwo, message];
}
...
function multiplyArray(multArr) { //eslint-disable-line
    var outputOne = multiply(multArr[0], multArr[1])[0];
    var outputTwo = multiply(outputOne, multArr[2])[0];
    var message = ('The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + outputTwo + '.');
    return[outputTwo, message];
}
